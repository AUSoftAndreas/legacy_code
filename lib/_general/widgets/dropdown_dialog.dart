                      ...
                      items: [
                        for (var i = 0; i < optionValues.length; i++)
                          DropdownMenuItem(
                            ...
                            child: optionLabels == null ? Text(optionValues[i].toString()) : Text(optionLabels![i]),
                          ),
                      ],
                    ),
                  ),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          child: Row(
                            children: [
                              Icon(widget.iconNo),
                              Expanded(child: Center(child: Text(widget.textNo))),
                            ],
                          ),
                          onPressed: () {
                      ...
                      Expanded(
                        child: ElevatedButton(
                          child: Row(
                            children: [
                              Icon(widget.iconYes),
                              Expanded(child: Center(child: Text(widget.textYes))),
                            ],
                          ),
                          onPressed: () {
                            _logger('Confirm pressed. Returning chosenOption: $chosenOption');
