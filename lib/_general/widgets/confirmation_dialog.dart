...
class ConfirmationDialog extends StatelessWidget {
  ...
  // TODO: [ZEIT-33] ConfirmationDialog aufhübschen
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            _logger('No-button pressed. Returning false.', 'build-closure');
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            _logger('Yes-button pressed. Returning true.', 'build-closure');
