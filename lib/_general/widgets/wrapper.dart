...
class Wrapper extends StatelessWidget {
  ...
  // TODO: [ADMIN-4] Menüeintrag markieren, wenn man auf der jeweiligen Seite ist
      ...
      listener: (context, state) {
        state.when(
          ...
          unverified: (user) {
            ...
            Navigator.of(context).pushReplacementNamed(EmailConfirmationView.routeName);
          },
          authenticated: (user) {},
          unauthenticated: () {
            _logger('Rerouting to EmailConfirmationView: build');
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        Navigator.of(context).pushNamed(TaetigkeitenView.routeName);
                      },
                    ),
                    ListTile(
