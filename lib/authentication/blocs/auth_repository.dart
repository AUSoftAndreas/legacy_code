...
class AuthRepository {
  ...
  /// Returns the [User] object of the newly created account if successful.
  Future<cdemy.User?> signUp({required String email, required String password}) async {
    try {
      ...
      _logger('Succeeded with firebase, trying to return the cdemy user.', 'signUp');
  ...
  /// - [email] The email of the user
  /// - [password] The password of the user
  /// Returns the [User] object of the signed in account if successful.
  Future<cdemy.User?> signIn({
    ...
    try {
      ...
      _logger('Succeeded with firebase, trying to return the cdemy user.', 'signIn');
      return _cdemyUserMapper(uc.user);
    } on FirebaseAuthException catch (e) {
  ...
  cdemy.User _cdemyUserMapper(User? firebaseUser) {
