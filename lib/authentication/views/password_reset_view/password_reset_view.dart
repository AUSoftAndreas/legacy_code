                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            _logger('Reset passworf requested for email $email', 'build-closure');
                            // TODO: [ZEIT-5] PasswordResetRequest erst nach Sicherheitsabfrage ausführen
                            final isConfirmed = await showDialog(
                              context: context,
                              builder: (context) => const ConfirmationDialog(
                                title: 'Passwort zurücksetzen',
                                messages: ['Möchten Sie eine E-Mail zum Zurücksetzen Ihres Passworts senden?'],
                              ),
                            );
                            if (isConfirmed ?? false) {
                              BlocProvider.of<AuthBloc>(context).add(PasswordResetRequested(_emailController.text));
                            }
                          },
                          child: Row(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            _logger('Navigating back to SignInView', 'build-closure');
