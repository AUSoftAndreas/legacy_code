  ...
  Widget build(BuildContext context) => Scaffold(
        body: BlocListener<AuthBloc, AuthState>(
          listener: (context, state) {
            state.maybeWhen(
              unverified: (u) {
                _logger('State-induced navigation to EmailConfirmationView', 'build-closure');
                Navigator.pushReplacementNamed(context, EmailConfirmationView.routeName);
              },
              authenticated: (u) {
                _logger('State-induced navigation to HomeView', 'build-closure');
                      ...
                      children: [
                          ...
                          child: Column(
                            children: [
                                ...
                                decoration: InputDecoration(
                                  suffixIcon: MouseRegion(
                                    child: GestureDetector(
                                      ...
                                      onTap: () {
                                        _logger('Toggled password visibility', 'build-closure');
                                        setState(() {
                              ...
                              RichText(
                                text: TextSpan(
                                  children: [
                                    const TextSpan(text: 'Passwort vergessen? ', style: TextStyle(color: Colors.black)),
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () async {
                                          _logger('User induced: Navigation to PasswordResetView', 'build-closure');
                                          ...
                                          if (isConfirmed ?? false) {
                                            await Navigator.of(context)
                                                .pushReplacementNamed(PasswordResetView.routeName);
                                          }
                                        },
                                    ),
                                  ],
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    _logger('User induced: SignIn with email and password', 'build-closure');
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              _logger('User induced: SignIn with Google', 'build-closure');
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            onPressed: () {
                              _logger('User induced: Navigation to SignUpView', 'build-closure');
