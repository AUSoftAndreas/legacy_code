        ...
        body: BlocListener<AuthBloc, AuthState>(
          ...
          child: BlocBuilder<AuthBloc, AuthState>(
            builder: (context, state) {
              ...
              final email = state is Authenticated ? state.user.email! : '(unbekannt)';
              return Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 12),
                      const Text('Oder lassen Sie sich die Email erneut zusenden.'),
                      const SizedBox(height: 12),
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            _logger('Sending of email requested', 'build-closure');
                            final response = await showDialog<bool>(
                                context: context,
                                builder: (context) => ConfirmationDialog(title: 'Emailversand', messages: [
                            ...
                            if (response ?? false) {
                              BlocProvider.of<AuthBloc>(context).add(ConfirmationEmailRequested());
                            }
                          },
                          child: Row(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            _logger('Signout requested. Navigating back to SignInView', 'build-closure');
