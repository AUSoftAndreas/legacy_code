...
class AbrechnungEvent with _$AbrechnungEvent {
  ...
  const factory AbrechnungEvent.addTaetigkeit(Taetigkeit taetigkeit) = AddTaetigkeit;

  /// Event indicating the user wants to remove a Taetigkeit from AbrechnungSettings
  const factory AbrechnungEvent.removeTaetigkeit(Taetigkeit taetigkeit) = RemoveTaetigkeit;
  ...
  const factory AbrechnungEvent.addAbwTaetigkeit(Kunde kunde, Taetigkeit taetigkeit) = AddAbwTaetigkeit;

  /// Event indicating the user wants to remove a abweichende Kostensatz from AbrechnungSettings
  const factory AbrechnungEvent.removeAbwTaetigkeit(Kunde kunde, Taetigkeit taetigkeit) = RemoveAbwTaetigkeit;
}
